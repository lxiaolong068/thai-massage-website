...
export default function ResetAdminPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-2xl font-bold mb-6">管理员账户重置页面</h1>
      ...
      <div className="bg-yellow-100 p-4 mb-6 border border-yellow-400 rounded text-yellow-800">
        <h3 className="font-bold">警告</h3>
        <p>此操作将重置管理员账户，请谨慎执行！</p>
        <p>重置后的账户：</p>
