      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Traditional Thai Massage</h3>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Neck & Shoulder</h3>
              <p className="text-gray-800 mb-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Oil Massage</h3>
              <p className="text-gray-800 mb-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Aromatherapy Massage</h3>
              <p className="text-gray-800 mb-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Deep Tissue Massage</h3>
              <p className="text-gray-800 mb-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-semibold mb-3 text-black">Foot Massage</h3>
              <p className="text-gray-800 mb-4">
