      ...
      <div className="fixed bottom-14 left-0 right-0 z-50 md:hidden bg-transparent pointer-events-none">
        {isExpanded ? (
          ...
          <div className="pointer-events-auto flex w-full divide-x divide-gray-300 border-t border-gray-300 bg-white/75 shadow-lg">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 448 512" fill="#06C755">
            ...
            <a 
              ...
              className="flex-1 py-3 flex items-center justify-center gap-1 text-gray-700 hover:bg-gray-50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 496 512" fill="#0088cc">
            ...
            {whatsappMethod && (
              <DialogTrigger asChild>
                <button
                  ...
                  className="flex-1 py-3 flex items-center justify-center gap-1 text-gray-700 hover:bg-gray-50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 448 512" fill="#25D366">
            ...
            {wechatMethod && (
              <DialogTrigger asChild>
                <button
                  ...
                  className="flex-1 py-3 flex items-center justify-center gap-1 text-gray-700 hover:bg-gray-50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 1024 1024" fill="#07C160">
